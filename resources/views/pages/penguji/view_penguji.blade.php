                                    ...
                                    <ul class="list-group custom-list-group mb-n3">
                                        <li class="list-group-item align-items-center d-flex justify-content-between pt-0">
                                            ...
                                            <div class="align-self-center">
                                                <a href="{{env('APP_URL')}}/download/form_f3/{{$item->id}}" class="btn btn-sm btn-soft-primary" target="_blank">Download File <i class="las la-external-link-alt font-15"></i></a>  
                                            </div>       
                                            @endforeach 
